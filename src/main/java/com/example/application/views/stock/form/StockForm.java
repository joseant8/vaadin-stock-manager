package com.example.application.views.stock.form;

import com.example.application.backend.model.Product;
import com.example.application.backend.model.StatusStock;
...
public class StockForm extends Dialog {
	...
	private ComboBox<StatusStock> status;
	
	public StockForm(ProductService productService, String title) {
		super();	
    ...
    private Component createFormLayout() {
		...
		status = new ComboBox<StatusStock>();
		status.setId("status");
		status.setLabel("Status");
		status.setItems(StatusStock.values());
